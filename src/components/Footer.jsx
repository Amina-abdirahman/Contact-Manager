...
function Footer() {
  return (
    <section class="py-10 bg-gray-800 sm:pt-10 ">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="flex flex-wrap items-center justify-between">
            <img class="h-20 auto md:order-1" src="Logoo.jpeg" alt="" />
            ...
            <p class="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2021, All Rights Reserved by Manage-Contacts</p>
        </div>
